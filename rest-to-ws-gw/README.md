...
You can then execute your native executable with: `./build/rest-to-ws-gw-1.0-SNAPSHOT-runner`
...
- Camel Vert.x
  WebSocket ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/vertx-websocket.html)): Camel
  WebSocket support with Vert.x
